...
const translations = {
    ...
    palavra: {
        ...
        playerClose: "Fechar",
        badgesTitle: "Distinções",
        badgesLoading: "A procurar distinções…",
        badgesNone: "Ainda sem distinções.",
        badgesNoneYours: "Ainda não tens distinções. Os três primeiros de cada mês recebem uma.",
        badgesPublishHelp: "Publica as tuas distinções no perfil Nostr para aparecerem ao teu lado noutras aplicações. As distinções de outros emissores mantêm-se.",
